...
train_dataset = utils.Food101MaskDataset(data_folder_images=food101path + '/images/',
                                         ...
                                         threshold=0.5, transform=transformer)
...
print("Train Dataset: ", len(train_dataset), "Test Dataset: ", len(test_dataset))
print("Size should be: ", 75750, 25250)
	...
	for i, data in enumerate(train_loader, 0):
		try:
			...
			if i == 100:
				...
				print("Estimated training time for 1 epoch: ", (len(train_loader) / 100) * (end - start) / 60,
				      " minutes")
				print("Estimate training for 90 epochs: ", (len(train_loader) / 100) * (end - start) / 60 * 90,
				      " minutes")
